#el bucle for funciona con listas [] tuplas () y conjuntos {}
...
#se pueden iterar dos o mas conjuntos a la vez, solo es necesario que ambas tengan el mismo numero de elementos
